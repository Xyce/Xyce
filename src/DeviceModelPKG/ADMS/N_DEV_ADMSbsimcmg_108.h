...
// This typedef is for our automatic differentiation:
  typedef Sacado::Fad::SFad<double,17> AdmsFadType;
...
public:
  ...
  private:
   ...
   // Probe numbers
    ...
    static const int admsProbeID_V_ge_d = 6;
    static const int admsProbeID_V_ge_s = 7;
    static const int admsProbeID_V_di_d = 8;
    static const int admsProbeID_V_si_s = 9;
    static const int admsProbeID_V_ge_e = 10;
    static const int admsProbeID_V_e_di = 11;
    static const int admsProbeID_V_e_si = 12;
    static const int admsProbeID_V_ge_di = 13;
    static const int admsProbeID_V_di_si = 14;
    static const int admsProbeID_V_ge_si = 15;
    static const int admsProbeID_Temp_t_GND = 16;
   // end probe numbers
   // Store LIDs
   // end store LIDs
