...
//
// Creation Date  : Fri, 27 Mar 2020 12:37:54
//
//-----------------------------------------------------------------------------
...
double & instanceVar_lp_rth,
double & instanceVar_lp_cth,
double & instanceVar_lp_strth,
double & instanceVar_pdiss,
double & instanceVar_dtsh,
...
public:
  ...
  private:
   ...
   // Probe numbers
    ...
    static const int admsProbeID_Temp_DT_GND = 14;
   // end probe numbers
   // Store LIDs
   // end store LIDs
