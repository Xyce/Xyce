...
//
// Creation Date  : Wed, 08 Apr 2020 18:53:26
//
//-----------------------------------------------------------------------------
...
public:
  ...
  private:
    ...
    double IDS=0.0;
     ...
     double d_IDS_dV_g_e=0.0;
     double d_IDS_dV_g_si=0.0;
     double d_IDS_dV_di_si=0.0;
     double d_IDS_dV_g_di=0.0;
    double IDEFF=0.0;
    double ISEFF=0.0;
    double IGTOT=0.0;
    double IDSGEN=0.0;
    ...
    double QGI=0.0;
     ...
     double d_QGI_dV_g_e=0.0;
     double d_QGI_dV_g_si=0.0;
     double d_QGI_dV_g_di=0.0;
    double QDI=0.0;
     double d_QDI_dV_di_si=0.0;
     double d_QDI_dV_e_si=0.0;
     double d_QDI_dV_e_di=0.0;
     double d_QDI_dV_g_e=0.0;
     double d_QDI_dV_g_si=0.0;
     double d_QDI_dV_g_di=0.0;
    double QSI=0.0;
     double d_QSI_dV_di_si=0.0;
     double d_QSI_dV_e_si=0.0;
     double d_QSI_dV_e_di=0.0;
     double d_QSI_dV_g_e=0.0;
     double d_QSI_dV_g_si=0.0;
     double d_QSI_dV_g_di=0.0;
    double QBI=0.0;
     double d_QBI_dV_e_si=0.0;
     double d_QBI_dV_e_di=0.0;
     double d_QBI_dV_g_e=0.0;
     double d_QBI_dV_g_si=0.0;
     double d_QBI_dV_di_si=0.0;
     double d_QBI_dV_g_di=0.0;
    double QG=0.0;
     double d_QG_dV_di_si=0.0;
     double d_QG_dV_e_si=0.0;
     double d_QG_dV_e_di=0.0;
     double d_QG_dV_g_e=0.0;
     double d_QG_dV_g_si=0.0;
     double d_QG_dV_g_di=0.0;
     double d_QG_dV_g_s=0.0;
     double d_QG_dV_g_d=0.0;
     double d_QG_dV_e_g=0.0;
    double QD=0.0;
     double d_QD_dV_di_si=0.0;
     double d_QD_dV_e_si=0.0;
     double d_QD_dV_e_di=0.0;
     double d_QD_dV_g_e=0.0;
     double d_QD_dV_g_si=0.0;
     double d_QD_dV_g_di=0.0;
     double d_QD_dV_g_d=0.0;
    ...
    double QS=0.0;
     ...
     double d_QS_dV_g_e=0.0;
     double d_QS_dV_g_si=0.0;
     double d_QS_dV_g_di=0.0;
     double d_QS_dV_g_s=0.0;
     double d_QS_dV_di_d=0.0;
     double d_QS_dV_si_s=0.0;
    double QB=0.0;
     double d_QB_dV_e_si=0.0;
     double d_QB_dV_e_di=0.0;
     double d_QB_dV_g_e=0.0;
     double d_QB_dV_g_si=0.0;
     double d_QB_dV_di_si=0.0;
     double d_QB_dV_g_di=0.0;
     double d_QB_dV_e_g=0.0;
    ...
    double CEE=0.0;
    double CGSEXT=0.0;
     double d_CGSEXT_dV_g_s=0.0;
     double d_CGSEXT_dV_g_di=0.0;
     double d_CGSEXT_dV_e_si=0.0;
     double d_CGSEXT_dV_e_di=0.0;
     double d_CGSEXT_dV_g_e=0.0;
     double d_CGSEXT_dV_g_si=0.0;
     double d_CGSEXT_dV_di_si=0.0;
    double CGDEXT=0.0;
     double d_CGDEXT_dV_g_d=0.0;
     double d_CGDEXT_dV_g_di=0.0;
     double d_CGDEXT_dV_e_si=0.0;
     double d_CGDEXT_dV_e_di=0.0;
     double d_CGDEXT_dV_g_e=0.0;
     double d_CGDEXT_dV_g_si=0.0;
