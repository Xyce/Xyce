...
//
// Creation Date  : Wed, 13 May 2020 09:19:21
//
//-----------------------------------------------------------------------------
...
public:
  ...
  private:
    ...
    double B4SOIueff;
     ...
     double d_B4SOIueff_dV_gi_si;
    double B4SOIthetavth;
     double d_B4SOIthetavth_dV_b_si;
     double d_B4SOIthetavth_dV_b_si_dV_b_si;
     double d_B4SOIthetavth_dV_b_si_dV_e_si;
    ...
    double B4SOIqinv;
     ...
     double d_B4SOIqinv_dV_sb_si;
     double d_B4SOIqinv_dV_b_si;
     double d_B4SOIqinv_dV_e_si;
    ...
    double B4SOIidovVds;
     ...
     double d_B4SOIidovVds_dV_gi_si;
    ...
    double gdnoise;
     ...
     double d_gdnoise_dV_b_si;
     double d_gdnoise_dV_e_si;
     double d_gdnoise_dV_di_si;
    ...
    double gsnoise;
     ...
     double d_gsnoise_dV_b_si;
     double d_gsnoise_dV_e_si;
     double d_gsnoise_dV_di_si;
     double d_gsnoise_dV_gi_si;
    double toxe;
    double epsrox;
    double epssub;
    double sqrt2qeps;
   ...
   // node numbers
    ...
    static const int admsNodeID_gi = 9;
    static const int admsNodeID_gm = 10;
    static const int admsNodeID_sb = 11;
    static const int admsNodeID_db = 12;
...
template<typename ScalarT> ScalarT lln(ScalarT x)
{
    ...
    ScalarT lln;
{
lln = adms_ternary_op((x>1.0e-38),log(x),(-87.498233533773742465));
}
return(lln);
}
