...
#ifndef Xyce_N_DEV_StepDelay_h
#define Xyce_N_DEV_StepDelay_h
...
{
  static const char *name() {return "Step delay element";}
  static const char *deviceTypeName() {return "Step Delay level 1";}
...
private:
  ...
  int li_storeVold;    ///< store for previous time's voltage
