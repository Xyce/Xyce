...
if ( CMAKE_HOST_UNIX )
  ...
  if( Xyce_PARALLEL_MPI )
    # an alternate way to set the openmpi dependency set( CPACK_RPM_PACKAGE_REQUIRES "openmpi >= 4.0")
    set( CPACK_RPM_PACKAGE_REQUIRES "libc.so.6(GLIBC_2.28)(64bit),libcurl.so.4()(64bit),libdl.so.2(GLIBC_2.17)(64bit),libgomp.so.1(GOMP_4.5)(64bit),libgomp.so.1(OMP_3.0)(64bit),libm.so.6(GLIBC_2.28)(64bit),libmpi.so.40()(64bit)(openmpi-${UNAME_MACHINE}),libpthread.so.0(GLIBC_2.28)(64bit),libblas.so.3()(64bit),liblapack.so.3()(64bit)" )
  else()
    set( CPACK_RPM_PACKAGE_REQUIRES "libc.so.6(GLIBC_2.28)(64bit),libcurl.so.4()(64bit),libdl.so.2(GLIBC_2.17)(64bit),libgomp.so.1(GOMP_4.5)(64bit),libgomp.so.1(OMP_3.0)(64bit),libm.so.6(GLIBC_2.28)(64bit),libpthread.so.0(GLIBC_2.28)(64bit),libblas.so.3()(64bit),liblapack.so.3()(64bit)" )
  endif()
