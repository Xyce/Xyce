...
macro(SUBDIRLIST result dirname)
...
macro(CONVERTTESTXML inputfn subdirname)
  file(STRINGS ${inputfn} lines_list)
  foreach(fline ${lines_list})
    if(${fline} MATCHES "BuildStamp=\"(.*)\"")
      string(REGEX REPLACE "(.*BuildStamp=)\"(.*)\""  "\\1\"${subdirname}-Experimental\"" outfline ${fline})
...
SUBDIRLIST(TESTSUBDIRS $ENV{WORKSPACE}/build/Testing)
