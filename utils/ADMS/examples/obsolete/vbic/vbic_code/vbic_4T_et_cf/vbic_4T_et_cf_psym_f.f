      subroutine vbic_4T_et_cf_f(p,Vrth,Vbei,Vbex,Vbci,Vbep,Vbcp,Vrcx
     +,Vbcx,Vrci,Vrbx,Vrbi,Vre,Vrbp,Vrs,Vbe,Vbc,Vcei,Vcep,Ibe,Ibex,Itzf
     +,Itzr,Ibc,Ibep,Ircx,Irci,Irbx,Irbi,Ire,Irbp,Qbe,Qbex,Qbc,Qbcx,Qbep
     +,Qbeo,Qbco,Ibcp,Iccp,Irs,Qbcp,Irth,Ith,Qcth,SCALE)
