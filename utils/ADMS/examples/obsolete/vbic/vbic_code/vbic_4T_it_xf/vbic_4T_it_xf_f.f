      subroutine vbic_4T_it_xf_f(p,Vbei,Vbex,Vbci,Vbep,Vbcp,Vrxf,Vrcx
     +,Vbcx,Vrci,Vrbx,Vrbi,Vre,Vrbp,Vrs,Vbe,Vbc,Vcxf,Ibe,Ibex,Itxf,Itzr
     +,Ibc,Ibep,Ircx,Irci,Irbx,Irbi,Ire,Irbp,Qbe,Qbex,Qbc,Qbcx,Qbep,Qbeo
     +,Qbco,Ibcp,Iccp,Irs,Qbcp,Ixzf,Ixxf,Qcxf,Flxf,SCALE)
