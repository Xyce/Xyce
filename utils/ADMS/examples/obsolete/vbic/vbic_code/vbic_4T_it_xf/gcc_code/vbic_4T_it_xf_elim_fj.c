...
int vbic_4T_it_xf_fj(p
	,Vbei,Vbex,Vbci,Vbep,Vbcp,Vrxf
	,Vrcx,Vbcx,Vrci,Vrbx,Vrbi,Vre,Vrbp
	,Vrs,Vbe,Vbc,Vcxf,Ibe,Ibe_Vbei,Ibex
	,Ibex_Vbex,Itxf,Itxf_Vrxf,Itzr,Itzr_Vbci,Itzr_Vbei,Ibc
	,Ibc_Vbci,Ibc_Vrxf,Ibc_Vbei,Ibep,Ibep_Vbep,Ircx,Ircx_Vrcx
	,Irci,Irci_Vrci,Irci_Vbci,Irci_Vbcx,Irbx,Irbx_Vrbx,Irbi
	,Irbi_Vrbi,Irbi_Vbei,Irbi_Vbci,Ire,Ire_Vre,Irbp,Irbp_Vrbp
	,Irbp_Vbep,Irbp_Vbci,Qbe,Qbe_Vbei,Qbe_Vbci,Qbex,Qbex_Vbex
	,Qbc,Qbc_Vbci,Qbcx,Qbcx_Vbcx,Qbep,Qbep_Vbep,Qbep_Vbci
	,Qbeo,Qbeo_Vbe,Qbco,Qbco_Vbc,Ibcp,Ibcp_Vbcp,Iccp
	,Iccp_Vbep,Iccp_Vbci,Iccp_Vbcp,Irs,Irs_Vrs,Qbcp,Qbcp_Vbcp
	,Ixzf,Ixzf_Vbei,Ixzf_Vbci,Ixxf,Ixxf_Vrxf,Qcxf,Qcxf_Vcxf
	,Flxf,Flxf_Vrxf,SCALE)
double *p
	,*Vbei,*Vbex,*Vbci,*Vbep,*Vbcp,*Vrxf
	,*Vrcx,*Vbcx,*Vrci,*Vrbx,*Vrbi,*Vre,*Vrbp
	,*Vrs,*Vbe,*Vbc,*Vcxf,*Ibe,*Ibe_Vbei,*Ibex
...
double	mv_Vbep,qdbep_vl,dvh_Vbcp,qlo_Vbcp,qhi_Vbcp,xvar1_Vbcp,xvar3_Vbcp;
double	qdbcp,qdbcp_qlo,qdbcp_Vbcp,qdbcp_Vbep,qdbcp_qhi,dv_Vbcp,mv_Vbcp;
double	vl_Vbcp,qdbcp_vl,argi,argi_Vbei,expi,expi_argi,expi_Vbei;
...
double	qbp_q2p,qbp_Vbep,qbp_Vbci,argi_Vbcp,expi_Vbcp,Irp,Irp_expi;
double	Irp_Vbcp,Iccp_Ifp,Iccp_Irp,Iccp_qbp,argn,argn_Vbei,expn;
...
double	avalf_vl,avalf_Vbci,avalf_xvar4,Igc,Igc_Itxf,Igc_Vrxf,Igc_Itzr;
double	Igc_Vbci,Igc_Vbei,Igc_Ibcj,Igc_avalf,Ibc_Ibcj,Ibc_Igc,argx_Vbcx;
...
double	Qbep_qdbep,Qbep_Ifp,Qbcp_qdbcp,Flxf_Ixxf;
