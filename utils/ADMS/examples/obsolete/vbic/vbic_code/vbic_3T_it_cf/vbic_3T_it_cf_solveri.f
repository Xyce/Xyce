...
20	continue
	...
	if(arg.EQ.'-h')then
		write(6,*) ''
		write(6,*) 'vbic_3T_it_cf_solveri: solver for model vbic_3T_it_cf'
		write(6,*) ''
		write(6,*) 'Usage: vbic_3T_it_cf_solveri [options] [ParameterFileName]'
...
c
	...
	gdc(7,7)=gdc(7,7)-Irbx_Vrbx
	gdc(7,3)=gdc(7,3)+Irbx_Vrbx
	f(3)=f(3)+Irbx
	gdc(3,7)=gdc(3,7)+Irbx_Vrbx
