...
int vbic_4T_et_xf_fj(p
	,Vrth,Vbei,Vbex,Vbci,Vbep,Vbcp
	,Vrxf,Vrcx,Vbcx,Vrci,Vrbx,Vrbi,Vre
	,Vrbp,Vrs,Vbe,Vbc,Vcei,Vcep,Vcxf
	,Ibe,Ibe_Vrth,Ibe_Vbei,Ibex,Ibex_Vrth,Ibex_Vbex,Itxf
	,Itxf_Vrxf,Itzr,Itzr_Vrth,Itzr_Vbci,Itzr_Vbei,Ibc,Ibc_Vrth
	,Ibc_Vbci,Ibc_Vrxf,Ibc_Vbei,Ibep,Ibep_Vrth,Ibep_Vbep,Ircx
	,Ircx_Vrcx,Ircx_Vrth,Irci,Irci_Vrci,Irci_Vrth,Irci_Vbci,Irci_Vbcx
	,Irbx,Irbx_Vrbx,Irbx_Vrth,Irbi,Irbi_Vrbi,Irbi_Vrth,Irbi_Vbei
	,Irbi_Vbci,Ire,Ire_Vre,Ire_Vrth,Irbp,Irbp_Vrbp,Irbp_Vrth
	,Irbp_Vbep,Irbp_Vbci,Qbe,Qbe_Vrth,Qbe_Vbei,Qbe_Vbci,Qbex
	,Qbex_Vrth,Qbex_Vbex,Qbc,Qbc_Vrth,Qbc_Vbci,Qbcx,Qbcx_Vrth
	,Qbcx_Vbcx,Qbep,Qbep_Vrth,Qbep_Vbep,Qbep_Vbci,Qbeo,Qbeo_Vbe
	,Qbco,Qbco_Vbc,Ibcp,Ibcp_Vrth,Ibcp_Vbcp,Iccp,Iccp_Vrth
	,Iccp_Vbep,Iccp_Vbci,Iccp_Vbcp,Irs,Irs_Vrs,Irs_Vrth,Qbcp
	,Qbcp_Vrth,Qbcp_Vbcp,Irth,Irth_Vrth,Ith,Ith_Vrth,Ith_Vbei
	,Ith_Vbci,Ith_Vrxf,Ith_Vcei,Ith_Vbex,Ith_Vbep,Ith_Vrs,Ith_Vbcp
	,Ith_Vcep,Ith_Vrcx,Ith_Vrci,Ith_Vbcx,Ith_Vrbx,Ith_Vrbi,Ith_Vre
	,Ith_Vrbp,Qcth,Qcth_Vrth,Ixzf,Ixzf_Vrth,Ixzf_Vbei,Ixzf_Vbci
...
double	qdbep_q0,dv0_PSatT,dvh_Vbcp,qlo_PSatT,qlo_Vbcp,qhi_Vbcp,qhi_PSatT;
double	xvar1_Vbcp,xvar3_Vbcp,qdbcp,qdbcp_qlo,qdbcp_Vrth,qdbcp_Vbcp,qdbcp_Vbep;
double	qdbcp_qhi,q0_PSatT,dv_Vbcp,mv_Vbcp,vl_Vbcp,qdbcp_vl,qdbcp_vl0;
double	qdbcp_q0,argi,argi_Vbei,argi_NFatT,argi_Vrth,argi_Vtv,expi;
...
double	Igc,Igc_Itxf,Igc_Vrxf,Igc_Itzr,Igc_Vrth,Igc_Vbci,Igc_Vbei;
double	Igc_Ibcj,Igc_avalf,Ibc_Ibcj,Ibc_Igc,Ircx_RCXatT,argx_Vbcx,expx_Vbcx;
double	Kbci,Kbci_GAMMatT,Kbci_Vrth,Kbci_expi,Kbci_Vbci,Kbcx,Kbcx_GAMMatT;
double	Kbcx_Vrth,Kbcx_expx,Kbcx_Vbcx,rKp1,rKp1_Kbci,rKp1_Vrth,rKp1_Vbci;
double	rKp1_Kbcx,rKp1_Vbcx,xvar1_rKp1,xvar1_Vbcx,Iohm,Iohm_Vrci,Iohm_Vtv;
double	Iohm_Vrth,Iohm_Kbci,Iohm_Vbci,Iohm_Kbcx,Iohm_Vbcx,Iohm_xvar1,Iohm_RCIatT;
double	derf,derf_IVO,derf_Vrth,derf_RCIatT,derf_Iohm,derf_Vrci,derf_Vbci;
double	derf_Vbcx,Irci_Iohm,Irci_derf,Irbx_RBXatT,Irbi_qb,Irbi_RBIatT,Ire_REatT;
double	Irbp_qbp,Irbp_RBPatT,argn_Vbcp,expn_Vbcp,Ibcp_IBCIPatT,Ibcp_expi,Ibcp_IBCNPatT;
double	Ibcp_expn,Irs_RSatT,sgIf,rIf,rIf_Ifi,rIf_Vrth,rIf_Vbei;
double	mIf,mIf_rIf,mIf_Vrth,mIf_Vbei,tff,tff_q1,tff_Vrth;
double	tff_Vbei,tff_Vbci,tff_xvar2,tff_mIf,Qbe_CJEatT,Qbe_qdbe,Qbe_tff;
double	Qbe_Ifi,Qbe_qb,Qbex_CJEatT,Qbex_qdbex,Qbc_CJCatT,Qbc_qdbc,Qbc_Iri;
double	Qbc_Kbci,Qbcx_Kbcx,Qbep_CJEPatT,Qbep_qdbep,Qbep_Ifp,Qbcp_CJCPatT,Qbcp_qdbcp;
double	Ith_Ibe,Ith_Ibc,Ith_Itxf,Ith_Itzr,Ith_Ibex,Ith_Ibep,Ith_Irs;
double	Ith_Ibcp,Ith_Iccp,Ith_Ircx,Ith_Irci,Ith_Irbx,Ith_Irbi,Ith_Ire;
double	Ith_Irbp,Flxf_Ixxf;
...
double	XRE,XRBI,XRCI,XRS,XVO,EA,EAIE;
double	EAIC,EAIS,EANE,EANC,EANS,XIS,XII;
double	XIN,TNF,TAVC,RTH,CTH,VRT,ART;
double	CCSO,QBM,NKF,XIKF,XRCX,XRBX,XRBP;
double	ISRR,XISR,DEAR,EAP,VBBE,NBBE,IBBE;
double	TVBBE1,TVBBE2,TNBBE;
