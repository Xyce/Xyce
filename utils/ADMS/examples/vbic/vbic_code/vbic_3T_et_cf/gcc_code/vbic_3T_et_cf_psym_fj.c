...
int vbic_3T_et_cf_fj(p
	,Vrth,Vbei,Vbex,Vbci,Vbep,Vrcx
	,Vbcx,Vrci,Vrbx,Vrbi,Vre,Vrbp,Vbe
	,Vbc,Vcei,Ibe,Ibe_Vrth,Ibe_Vbei,Ibex,Ibex_Vrth
	,Ibex_Vbex,Itzf,Itzf_Vrth,Itzf_Vbei,Itzf_Vbci,Itzr,Itzr_Vrth
	,Itzr_Vbci,Itzr_Vbei,Ibc,Ibc_Vrth,Ibc_Vbci,Ibc_Vbei,Ibep
	,Ibep_Vrth,Ibep_Vbep,Ircx,Ircx_Vrcx,Ircx_Vrth,Irci,Irci_Vrci
	,Irci_Vrth,Irci_Vbci,Irci_Vbcx,Irbx,Irbx_Vrbx,Irbx_Vrth,Irbi
	,Irbi_Vrbi,Irbi_Vrth,Irbi_Vbei,Irbi_Vbci,Ire,Ire_Vre,Ire_Vrth
	,Irbp,Irbp_Vrbp,Irbp_Vrth,Irbp_Vbep,Irbp_Vbci,Qbe,Qbe_Vrth
	,Qbe_Vbei,Qbe_Vbci,Qbex,Qbex_Vrth,Qbex_Vbex,Qbc,Qbc_Vrth
	,Qbc_Vbci,Qbcx,Qbcx_Vrth,Qbcx_Vbcx,Qbep,Qbep_Vrth,Qbep_Vbep
	,Qbep_Vbci,Qbeo,Qbeo_Vbe,Qbco,Qbco_Vbc,Irth,Irth_Vrth
	,Ith,Ith_Vrth,Ith_Vbei,Ith_Vbci,Ith_Vcei,Ith_Vbex,Ith_Vbep
	,Ith_Vrcx,Ith_Vrci,Ith_Vbcx,Ith_Vrbx,Ith_Vrbi,Ith_Vre,Ith_Vrbp
	,Qcth,Qcth_Vrth,SCALE)
double *p
	,*Vrth,*Vbei,*Vbex,*Vbci,*Vbep,*Vrcx
	,*Vbcx,*Vrci,*Vrbx,*Vrbi,*Vre,*Vrbp,*Vbe
	,*Vbc,*Vcei,*Ibe,*Ibe_Vrth,*Ibe_Vbei,*Ibex,*Ibex_Vrth
...
double	qdbep_qlo0,dv_Vbep,mv_Vbep,qdbep_vl,qdbep_vl0,qdbep_q0,argi;
...
double	avalf_vl,avalf_Vrth,avalf_Vbci,avalf_xvar4,Igc,Igc_Itzf,Igc_Vrth;
double	Igc_Vbei,Igc_Vbci,Igc_Itzr,Igc_Ibcj,Igc_avalf,Ibc_Ibcj,Ibc_Igc;
double	Ircx_RCXatT,argx_Vbcx,expx_Vbcx,Kbci,Kbci_GAMMatT,Kbci_Vrth,Kbci_expi;
double	Kbci_Vbci,Kbcx,Kbcx_GAMMatT,Kbcx_Vrth,Kbcx_expx,Kbcx_Vbcx,rKp1;
double	rKp1_Kbci,rKp1_Vrth,rKp1_Vbci,rKp1_Kbcx,rKp1_Vbcx,xvar1_rKp1,xvar1_Vbcx;
double	Iohm,Iohm_Vrci,Iohm_Vtv,Iohm_Vrth,Iohm_Kbci,Iohm_Vbci,Iohm_Kbcx;
double	Iohm_Vbcx,Iohm_xvar1,Iohm_RCIatT,derf,derf_IVO,derf_Vrth,derf_RCIatT;
double	derf_Iohm,derf_Vrci,derf_Vbci,derf_Vbcx,Irci_Iohm,Irci_derf,Irbx_RBXatT;
double	Irbi_qb,Irbi_RBIatT,Ire_REatT,Irbp_qbp,Irbp_RBPatT,sgIf,rIf;
double	rIf_Ifi,rIf_Vrth,rIf_Vbei,mIf,mIf_rIf,mIf_Vrth,mIf_Vbei;
double	tff,tff_q1,tff_Vrth,tff_Vbei,tff_Vbci,tff_xvar2,tff_mIf;
double	Qbe_CJEatT,Qbe_qdbe,Qbe_tff,Qbe_Ifi,Qbe_qb,Qbex_CJEatT,Qbex_qdbex;
double	Qbc_CJCatT,Qbc_qdbc,Qbc_Iri,Qbc_Kbci,Qbcx_Kbcx,Qbep_CJEPatT,Qbep_qdbep;
double	Qbep_Ifp,Ith_Ibe,Ith_Ibc,Ith_Itzf,Ith_Itzr,Ith_Ibex,Ith_Ibep;
double	Ith_Ircx,Ith_Irci,Ith_Irbx,Ith_Irbi,Ith_Ire,Ith_Irbp;
...
double	QTF,XTF,VTF,ITF,TR,XRE,XRBI;
double	XRCI,XRS,XVO,EA,EAIE,EAIC,EAIS;
double	EANE,EANC,EANS,XIS,XII,XIN,TNF;
double	TAVC,RTH,CTH,VRT,ART,QBM,NKF;
double	XIKF,XRCX,XRBX,XRBP,ISRR,XISR,DEAR;
double	EAP,VBBE,NBBE,IBBE,TVBBE1,TVBBE2,TNBBE;
