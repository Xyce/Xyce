...
c
	...
	double precision x(8),xlast(8),xinit(8)
...
20	continue
	...
	if(arg.EQ.'-h')then
		write(6,*) ''
		write(6,*) 'vbic_4T_et_cf_solverv: solver for model vbic_4T_et_cf'
		write(6,*) ''
		write(6,*) 'Usage: vbic_4T_et_cf_solverv [options] [ParameterFileName]'
...
c
	...
	implicit double precision (a-z)
	integer n,i,j,k,ii,jj,itmax,nit,ipvt(8)
	integer errflg,nfail
	double precision p(108),xx(4),vmx(5),imx(4)
	double precision x(8),f(8),gdc(8,8)
	double precision G(10,10),C(10,10),xxlast(4)
