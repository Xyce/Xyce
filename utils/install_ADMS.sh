...
cp utils/ADMS/examples/EKV/ekv-2.6/N_DEV_ADMSekv_va.h src/DeviceModelPKG/ADMS
cp utils/ADMS/examples/EKV/ekv-2.6/N_DEV_ADMSekv_va.C src/DeviceModelPKG/ADMS
