...
only the \texttt{AVG}, \texttt{ERROR}, \texttt{EQN}, \texttt{FIND-WHEN}, \texttt{MIN},
\texttt{MAX}, \texttt{PP} and \texttt{WHEN} measures are supported.  For \texttt{.AC}
analyses, only the \texttt{AVG}, \texttt{EQN}, \texttt{FIND-WHEN}, \texttt{MIN},
\texttt{MAX}, \texttt{PP} and \texttt{WHEN} measures are supported.  Also, note that
