...
only the \texttt{AVG}, \texttt{DERIV}, \texttt{ERROR}, \texttt{EQN}, \texttt{FIND-WHEN},
\texttt{INTEG}, \texttt{MIN}, \texttt{MAX}, \texttt{PP}, \texttt{RMS} and \texttt{WHEN}
measures are supported.  For \texttt{.AC} analyses, only the \texttt{AVG}, \texttt{DERIV},
\texttt{EQN}, \texttt{FIND-WHEN}, \texttt{INTEG}, \texttt{MIN}, \texttt{MAX}, \texttt{PP},
\texttt{RMS} and \texttt{WHEN} measures are supported.  Also, note that
