...
\Xyce{} supports both positive and negative values for the \texttt{RISE}, \texttt{FALL}
and \texttt{CROSS} qualifiers.  However, their interpretation is slightly different for
