...
The BSIM CMG version 107 device supports output of the internal variables in
table~\ref{M_107_OutputVars} on the \texttt{.PRINT} line of a netlist.
To access them from a print line, use the syntax
\texttt{N(<instance>:<variable>)} where ``\texttt{<instance>}'' refers to the
name of the specific level 107 M device in your netlist.
