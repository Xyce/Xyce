...
The BSIM CMG version 107 and 108 devices support output of the internal variables in
tables~\ref{M_107_OutputVars} and~\ref{M_107_OutputVars} on the \texttt{.PRINT} line of a netlist.
To access them from a print line, use the syntax
\texttt{N(<instance>:<variable>)} where ``\texttt{<instance>}'' refers to the
