...
\textbf{NOTE:} Shortly before Release 7.1 was frozen for release, it
was reported that the level 70 MOSFET model suffers from severe
convergence problems when SHMOD=1.  This issue is under investigation,
but we were unable to fix it in time for the 7.1 release.
