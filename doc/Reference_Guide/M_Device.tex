...
\subsubsection{Level 2002 MOSFET Tables (MVSG-HV version 1.1.0)}
\Xyce{} includes the MIT Virtual Source GaN HEMT High-Voltage
(MVSG-HV) MOSFET model version 1.1.0.  The code in \Xyce{} was
generated from the MIT Verilog-A input.  Model parameters for the MVS
...
obtained from the NEEDS web site at
\url{https://nanohub.org/publications/73/1}.
