...
\item Wildcards are partially supported on \texttt{.PRINT}
  ...
  the circuit for all analysis modes.  The \texttt{P(*)} and
  \texttt{W(*)} wildcards are supported for TRAN and DC analyses.
  \texttt{I(*)} will print all of the currents that are
