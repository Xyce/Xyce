...
\item \texttt{VP(<circuit node>)} to output the phase of voltage response
...
\item \texttt{VP(<circuit node>,<circuit node>)} to output the phase of voltage response between two nodes in the circuit
...
\item \texttt{IP(<device>)} to output the phase of the current through a two terminal device
