...
in that it can only be defined
at the main circuit level.   Also, while both normal and global parameters are allowed to
change during a simulation, only global parameters can be modified by netlist commands 
such as \texttt{.STEP} and \texttt{.SAMPLING}.  Examples of some
