...
\begin{NetlistFigure}{Sample use of the diagnostic EXTREMALIMIT}
* 4049 Circuit
...
Thus, for best use of discontinuity output, one may need to try turning step error control on and
