...
\begin{XyceItemize}
  \item The BSIM SOI version 4.6.1 has been added as the level 70
    ...
    four-node version without exposed body nodes.  Furthermore, we
    have observed severe convergence problems when SHMOD=1.  The
    convergence issues are under investigation, but we were unable to
    fix them in time for this release.
