...
\begin{XyceItemize}
  \item The lossless transmission line history interpolation has been
        ...
        produced by pulsed voltage sources.
\end{XyceItemize}
...
supported on .PRINT lines for all analysis modes.
  \item The Xyce expression library now recognizes \texttt{TEMPER} and \texttt{HERTZ} 
as synonyms for \texttt{TEMP} and \texttt{FREQ}, respectively.
\end{XyceItemize}
