...
Xyce/ADMS would emit an error about an undefined variable if one used \$vt as the input argument to an analog function that had both input and output arguments. \\ \hline
