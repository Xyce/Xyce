...
\begin{XyceItemize}
\item The \texttt{TABLE} expression feature now allows time-dependent tables to be specified out of order.  The expression code in \Xyce{} will now automatically sort time-dependent tabular data.
\end{XyceItemize}
