...
\item  \Xyce{} can now handle the sources that specify both DC and transient values during source stepping. Previously, source stepping does not apply to these sources. This leads to improved robustness and convergence of source stepping for DC op.
