...
\begin{longtable}[h] {>{\raggedright\small}m{2in}|>{\raggedright\let\\\tabularnewline\small}m{3.5in}}
  ...
  of the DC op was incorrect & When Xyce cannot take the first transient step out
  of the DC op, it incorrectly reported that Xyce reaches the maximum local error
