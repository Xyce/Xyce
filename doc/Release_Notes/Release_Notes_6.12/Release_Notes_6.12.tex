...
\item The Xyce/ADMS code generation back-end has been improved to
  allow handling of analog functions with output variables other than
  their return value, and has been refactored to generate analytic
  derivatives without the use of Sacado.  This refactor allows
  Xyce/ADMS to produce C++ code that evaluates model residuals and
  jacobians much more efficiently than before.
\end{XyceItemize}
