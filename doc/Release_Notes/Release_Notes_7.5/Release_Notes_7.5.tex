...
\item The new harmonics selection method based on box truncation is added
 for HB analysis
\item Parameter handling for \texttt{.SAMPLING} and other UQ methods is now much more efficient 
  (see issue 306 in the fixed defects table).
\end{XyceItemize}
