...
\begin{XyceItemize}
  \item \Xyce{} has removed support for autotools configuration and build system for release 7.11. This notice is only relevant for users that build Xyce from source code. Please consult the CMake building guide for updated information: \newline
